...
git clone https://github.com/AUTOMATIC1111/stable-diffusion-webui.git /content/$1
...
wget -c https://huggingface.co/dhjhhu/pp/resolve/main/vqgan_cfw_00011_vae_only.ckpt -P ./models/VAE/vqgan_cfw_00011_vae_only.ckpt
